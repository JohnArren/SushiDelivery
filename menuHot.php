...
?>
	...
	<footer class="page-footer text-center font-small mt-4 wow fadeIn">
		<div class="pt-4">
			<a href="#" role="button" class="btn btn-outline-white">Главная
				<i class="fa fa-graduation-cap ml-2"></i>
			</a>
			<a href="#" role="button" class="btn btn-outline-white">Меню
				<i class="fa fa-graduation-cap ml-2"></i>
			</a>
			<a href="#" role="button" class="btn btn-outline-white">О нас
				<i class="fa fa-graduation-cap ml-2"></i>
			</a>
			<a href="#" role="button" class="btn btn-outline-white">Акции
				<i class="fa fa-graduation-cap ml-2"></i>
			</a>
			<a href="#" role="button" class="btn btn-outline-white">Отзывы
				<i class="fa fa-graduation-cap ml-2"></i>
			</a>
		</div>
		...
		<hr class="my-4">
		<div class="pb-4">
			<a href="https://vk.com/zolotoidrakon.sarapul">
			...
			<a href="https://www.pinterest.ru/">
				<i class="fa fa-pinterest gmr-3"></i>
			</a>
		</div>
